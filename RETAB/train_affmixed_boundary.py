...
if __name__ == '__main__':
    ...
    parser.add_argument("--session_name", default="resnet38_affgt", type=str)
    ...
    parser.add_argument("--novel_dir", required=True, type=str)
    ...
    # train_dataset = voc12.data.VOC12AffGtDataset(args.train_list, label_dir=args.gt_dir,
    train_dataset = voc12.data.VOC12AffMixedDatasetMask(args.train_list, label_la_dir=args.la_crf_dir, label_ha_dir=args.ha_crf_dir, mask_dir=args.targetpixel_dir, label_dir=args.gt_dir, base_dir=args.base_dir, novel_dir=args.novel_dir, 
